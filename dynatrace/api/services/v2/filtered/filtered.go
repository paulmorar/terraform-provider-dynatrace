...
type Filter[T api.Settings] interface {
	Filter(v T) (bool, error)
	Suffix() string
}

type FilterService[T api.Settings] struct {
...
func Service[T api.Settings](service api.CRUDService[T], f Filter[T]) api.CRUDService[T] {
