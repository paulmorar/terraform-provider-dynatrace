...
func (me AttributeConditions) MarshalHCL(decoder hcl.Decoder) (map[string]any, error) {
...
func (me *AttributeCondition) MarshalHCL(decoder hcl.Decoder) (map[string]any, error) {
