...
func Service(credentials *api.Credentials) api.RService[*services.Settings] {
	return api.NewCRUDService(
		credentials,
		SchemaID,
		api.DefaultServiceOptions[*services.Settings](BasePath).WithStubs(new(services.Services)),
	)
}
